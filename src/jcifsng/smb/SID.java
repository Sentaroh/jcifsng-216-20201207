 ...
 * @internal
 */
public class SID extends rpc.sid_t implements jcifsng.SID {
    ...
    public static byte[] toByteArray ( rpc.sid_t sid ) {
        ...
        for ( int ii = 0; ii < sid.sub_authority_count; ii++ ) {
            jcifsng.util.Encdec.enc_uint32le(sid.sub_authority[ ii ], dst, di);
            di += 4;
        }
        return dst;
    }
     ...
     * {@inheritDoc}
     *
     * @see jcifsng.SID#unwrap(java.lang.Class)
     */
     ...
     * @throws IOException
     */
    public jcifsng.SID[] getGroupMemberSids ( String authorityServerName, CIFSContext tc, int flags ) throws IOException {
