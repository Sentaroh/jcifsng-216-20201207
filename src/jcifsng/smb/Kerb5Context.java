...
class Kerb5Context implements SSPContext {
     ...
     * {@inheritDoc}
     *
     * @see jcifsng.smb.SSPContext#supportsIntegrity()
     */
    @Override
     ...
     *
     * @see jcifsng.smb.SSPContext#calculateMIC(byte[])
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng.smb.SSPContext#verifyMIC(byte[], byte[])
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng.smb.SSPContext#isMICAvailable()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng.smb.SSPContext#getNetbiosName()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng.smb.SSPContext#getSigningKey()
     */
    @Override
