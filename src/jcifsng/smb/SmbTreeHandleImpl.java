...
class SmbTreeHandleImpl implements SmbTreeHandleInternal {
     ...
     * {@inheritDoc}
     *
     * @see jcifsng.SmbTreeHandle#isConnected()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng.SmbTreeHandle#getConfig()
     */
    @Override
     ...
     */
    public <T extends CommonServerMessageBlockResponse> T send ( jcifsng.internal.Request<T> req, RequestParam... params ) throws CIFSException {
     ...
     * {@inheritDoc}
     *
     * @see jcifsng.SmbTreeHandle#close()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng.SmbTreeHandle#getRemoteHostName()
     */
    @Override
     ...
     * @throws SmbException
     *
     * @see jcifsng.SmbTreeHandle#getServerTimeZoneOffset()
     */
    @Override
     ...
     * @throws SmbException
     *
     * @see jcifsng.SmbTreeHandle#getOEMDomainName()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng.SmbTreeHandle#getTreeType()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng.SmbTreeHandle#getConnectedShare()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng.SmbTreeHandle#isSameTree(jcifsng.SmbTreeHandle)
     */
    @Override
