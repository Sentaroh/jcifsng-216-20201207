...
public class JAASAuthenticator extends Kerb5Authenticator implements CallbackHandler, SmbRenewableCredentials {
     ...
     * {@inheritDoc}
     *
     * @see jcifsng.smb.Kerb5Authenticator#isAnonymous()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng.smb.NtlmPasswordAuthenticator#isGuest()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng.smb.Kerb5Authenticator#refresh()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng.smb.Kerb5Authenticator#getSubject()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng.smb.SmbRenewableCredentials#renew()
     */
    @Override
