...
public class NtlmPasswordAuthentication extends NtlmPasswordAuthenticator {
     ...
     * {@inheritDoc}
     *
     * @see jcifsng.smb.NtlmPasswordAuthenticator#getAnsiHash(jcifsng.CIFSContext, byte[])
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng.smb.NtlmPasswordAuthenticator#getUnicodeHash(jcifsng.CIFSContext, byte[])
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng.smb.NtlmPasswordAuthenticator#getUserSessionKey(jcifsng.CIFSContext, byte[])
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng.smb.NtlmPasswordAuthenticator#getUserSessionKey(jcifsng.CIFSContext, byte[], byte[], int)
     */
    @Override
