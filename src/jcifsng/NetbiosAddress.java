...
public interface NetbiosAddress extends Address {
     ...
     * @param tc
     *            context to use
     * @return {@link jcifsng.netbios.NbtAddress#B_NODE},
     *         {@link jcifsng.netbios.NbtAddress#P_NODE}, {@link jcifsng.netbios.NbtAddress#M_NODE},
     *         {@link jcifsng.netbios.NbtAddress#H_NODE}
     *
     * @throws UnknownHostException
     *             if the host cannot be resolved to find out.
     */
