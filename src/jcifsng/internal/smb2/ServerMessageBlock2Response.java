...
public abstract class ServerMessageBlock2Response extends ServerMessageBlock2 implements CommonServerMessageBlockResponse {
     ...
     * {@inheritDoc}
     *
     * @see jcifsng.internal.smb2.ServerMessageBlock2#reset()
     */
    @Override
    public void reset () {
        super.reset();
     ...
     * {@inheritDoc}
     *
     * @see jcifsng.util.transport.Response#clearReceived()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng.util.transport.Response#isReceived()
     */
    @Override
     ...
     *
     * @see jcifsng.internal.smb2.ServerMessageBlock2#haveResponse(byte[], int, int)
     */
    @Override
