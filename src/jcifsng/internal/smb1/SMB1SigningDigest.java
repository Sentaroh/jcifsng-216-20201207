...
public class SMB1SigningDigest implements SMBSigningDigest {
     ...
     * {@inheritDoc}
     *
     * @see jcifsng.internal.SMBSigningDigest#sign(byte[], int, int, jcifsng.internal.CommonServerMessageBlock,
     *      jcifsng.internal.CommonServerMessageBlock)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng.internal.SMBSigningDigest#verify(byte[], int, int, int, jcifsng.internal.CommonServerMessageBlock)
     */
    @Override
