...
import jcifsng.smb.NtlmChallenge;
import jcifsng.smb.NtlmPasswordAuthentication;
import jcifsng.smb.SmbAuthException;
import jcifsng.smb.SmbException;
import jcifsng.smb.SmbSessionInternal;
    ...
    protected NtlmPasswordAuthentication negotiate ( HttpServletRequest req, HttpServletResponse resp, boolean skipAuthentication )
        ...
        if ( msg != null && ( msg.startsWith("NTLM ") || ( offerBasic && msg.startsWith("Basic ") ) ) ) {
            ...
            try {
                ...
                log.warn("NtlmHttpFilter: " + ntlm.getName() + ": 0x" + jcifsng.util.Hexdump.toHexString(sae.getNtStatus(), 8) + ": " + sae);
