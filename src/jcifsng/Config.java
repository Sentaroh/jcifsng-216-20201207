 ...
 * 
 * We strongly suggest that you create an explicit {@link jcifsng.context.CIFSContextWrapper}
 * with your desired config. It's base implementation {@link jcifsng.context.BaseContext}
 * should be sufficient for most needs.
 * 
 * If you want to retain the classic singleton behavior you can use
 * {@link jcifsng.context.SingletonContext#getInstance()}
